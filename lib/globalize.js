...
function error() {
  return packMessage(arguments, function(msg) {
    ...
    if (helper.consoleEnabled()) console.error(msg.message);
  }, true);
}

function warn() {
  return packMessage(arguments, function(msg) {
    helper.logPersistent(msg, 'warn');
    if (helper.consoleEnabled()) console.warn(msg.message);
  }, true);
}
...
function info() {
  return packMessage(arguments, function(msg) {
    ...
    if (helper.consoleEnabled()) console.info(msg.message);
  }, true);
}
...
function log() {
  return packMessage(arguments, function(msg) {
    helper.logPersistent(msg, 'info');
    if (helper.consoleEnabled()) console.log(msg.message);
  }, true);
}

function verbose() {
  return packMessage(arguments, function(msg) {
    helper.logPersistent(msg, 'verbose');
    if (helper.consoleEnabled()) console.log(msg.message);
  }, true);
}
...
function myDebug() {
  return packMessage(arguments, function(msg) {
    helper.logPersistent(msg, 'debug');
    if (helper.consoleEnabled()) console.log(msg.message);
  }, true);
}
