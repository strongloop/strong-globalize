 ...
 */
function enumerateFilesSync(dir, blackList, targetFileType, verbose, callback) {
  ...
  files.forEach(function(item) {
    ...
    if (stats.isDirectory()) {
      ...
      enumerateFilesSync(child, blackList, targetFileType, false, callback);
    } else {
      ...
      if (verbose) console.log('~~~ examining:', child);
      callback(content);
    };
  });
}
