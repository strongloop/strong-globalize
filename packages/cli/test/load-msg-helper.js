...
var msgWanted = {
  ...
  es: [
    ...
    new RegExp(
      '^(Mensaje de profundidad de cuatro segundos' +
  ...
  pt: [
    ...
    new RegExp(
      '^((Na quar|Quar)ta segundo a profundidade da mensagem' +
...
function secondaryMgr(rootDir, lang, t, aml, positive, callback) {
  ...
  t.ok(
    msgFound[0].indexOf('StrongGlobalize persistent logging started') === 0,
