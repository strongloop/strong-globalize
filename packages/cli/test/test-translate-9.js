...
if (skipTranslate) {
  test(
    'skip translate error ' + gpbHelper.FAKE_bundle_getEntryInfo_2,
    function (t) {
      t.pass();
      t.end();
    }
  ...
  test(
    'test translate error ' + gpbHelper.FAKE_bundle_getEntryInfo_2,
    function (t) {
      gpbHelper.fakeGpbTest(
        t,
        gpbHelper.FAKE_bundle_getEntryInfo_2,
        function () {
          t.pass();
          t.end();
        }
