...
if (skipTranslate) {
  test('skip translate error ' + gpbHelper.FAKE_bundle_uploadStrings,
    function(t) {
      t.pass();
      t.end();
    }
  ...
  test('test translate error ' + gpbHelper.FAKE_bundle_uploadStrings,
    function(t) {
      gpbHelper.fakeGpbTest(t, gpbHelper.FAKE_bundle_uploadStrings,
