...
if (skipTranslate) {
  test('skip translate error ' + gpbHelper.FAKE_bundle_getStrings_1,
    function(t) {
      t.pass();
      t.end();
    }
  ...
  test('test translate error ' + gpbHelper.FAKE_bundle_getStrings_1,
    function(t) {
      gpbHelper.fakeGpbTest(t, gpbHelper.FAKE_bundle_getStrings_1,
